...
r_one_one   = Recipient.create(phone: '5005550006', user: user)
r_one_two   = Recipient.create(phone: '5005550007', email: 'recipient3@tb.tb.moc', user: user)
r_one_three = Recipient.create(phone: '0005551214', email: 'recipient4@tb.tb.moc', user: user)
Recipient.create(phone: '5005550008', email: 'recipient5@tb.tb.moc', user: user)
Recipient.create(phone: '5005550009', email: 'recipient6@tb.tb.moc', user: user)
r_two_one = Recipient.create(phone: '0005551221', email: 'recipient1.2@tb.tb.moc', user: user_two)
Recipient.create(phone: '5005550010', email: 'recipient2.2@tb.tb.moc', user: user_two)
Recipient.create(phone: '5005550011', email: 'recipient3.2@tb.tb.moc', user: user_two)
